...
LessonKit **1.7.x** extends the **0.9.x conformance harness** with Vitest CLI integration tests and Playwright launch coverage for SCORM 2004, xAPI, and cmi5. Last verified against release **1.7.3**.
