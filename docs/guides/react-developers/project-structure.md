...
Central runtime config: telemetry sinks, xAPI transport, observability hooks, and `lxpack.bridge`. Set `bridge: "auto"` and `allowedParentOrigins` before LMS packaging. See [LMS Go-Live](lms-go-live.md).
