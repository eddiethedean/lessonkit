...
Archived release checklists from earlier versions. Current procedure: [RELEASING.md](https://github.com/eddiethedean/lessonkit/blob/main/RELEASING.md).
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.4.0]` documents InteractiveVideo, Studio removal, audit **Fixed** pass, and dependency refresh | Done |
| Sphinx `docs/conf.py` `release` = `1.4.0` | Done |
| [MIGRATION-1.3-to-1.4.md](../MIGRATION-1.3-to-1.4.md) in Sphinx toctree | Done |
| Docs updated for 1.4 observability, production guard, init template, and Node 20 | Done |
| `lessonkit init` template pins `^1.4.0` (React 19, Vite 8) | Done |
...
| `main` CI green (includes #25 dependency batch) | Done (2026-06-06) |
| `npm run lint` + `typecheck` + `test` + `test:integration` + `test:e2e` | Done locally (2026-06-06); CI green on `main` |
| `npm audit --omit=dev --audit-level=high` | 0 high/critical (2026-06-06) |
| npm latest `@lessonkit/react` | **1.3.x** — publish with `v1.4.0` |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.3.1]` documents production hardening patch | Done |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.3.0]` documents `Slide`, `SlideDeck`, `slide_viewed`, and **Fixed** audit pass | Done |
| [MIGRATION-1.2-to-1.3.md](../MIGRATION-1.2-to-1.3.md) in Sphinx toctree | Done |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.2.0]` includes **Changed** (catalog v3 default, compound persistence, AssessmentSequence scores) | Done |
| [MIGRATION-1.1-to-1.2.md](../MIGRATION-1.1-to-1.2.md) in Sphinx toctree | Done |
...
- `main` is green (see [CI workflow](https://github.com/eddiethedean/lessonkit/blob/main/.github/workflows/checks.yml)).
- All `packages/*/package.json` versions match the release.
- [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) documents the release.
- No pending files in [`.changeset/`](https://github.com/eddiethedean/lessonkit/tree/main/.changeset) that would run `changeset version` and bump versions unexpectedly (this repo publishes via **git tags**, not `changeset publish`).

> **1.0.0** is the stable public API release. See [MIGRATION-0.x-to-1.0.md](../MIGRATION-0.x-to-1.0.md).
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.1.0]` (includes audit fixes on `main`) | Done |
| Assessment contract, telemetry-catalog v2, block-catalog v2 | Done |
| P0 blocks + `examples/assessments-p0` + integration/e2e | Done |
| [MIGRATION-1.0-to-1.1.md](../MIGRATION-1.0-to-1.1.md) | Done |
| No pending `.changeset/*.md` files | Done |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.0.2]` documents the patch | Done |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.0.1]` documents the patch | Done |
| No pending `.changeset/*.md` files | Done (only `config.json`) |
...
| [MIGRATION-0.x-to-1.0.md](../MIGRATION-0.x-to-1.0.md) reviewed | Done |
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.0.0]` (+ maintenance entries on `main`) | Done |
...
| [MIGRATION-0.x-to-1.0.md](../MIGRATION-0.x-to-1.0.md) | Done |
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [1.0.0-beta.1]` | Done (local) |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [0.9.3]` (bugfix pass) | Done (local) |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [0.9.1]` (includes 0.9.1 bugfix pass) | Done (local) |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [0.9.0]` (plugins + conformance harness) | Done |
...
| Item | Status |
|------|--------|
| `main` CI green ([workflow](https://github.com/eddiethedean/lessonkit/blob/main/.github/workflows/checks.yml): build, typecheck, test, coverage on Node 18 + 20; packaging + CLI smoke on Node 20) | Required |
...
| [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) `## [0.8.0]` includes Added / Changed | Required |
...
3. When ready to publish, create and push the version tag (triggers [Release workflow](https://github.com/eddiethedean/lessonkit/blob/main/.github/workflows/release.yml)):
...
- Optional: create a GitHub Release from the tag with notes copied from [CHANGELOG.md](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md).
