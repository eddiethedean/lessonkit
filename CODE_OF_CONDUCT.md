...
We as members, contributors, and leaders pledge to make participation in the LessonKit community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers through [GitHub private contact](https://github.com/eddiethedean/lessonkit/security/advisories/new) or by opening an issue if you prefer a public thread for non-sensitive conduct concerns.
