...
| [`packages/cli/template/vite-react/`](https://github.com/eddiethedean/lessonkit/tree/main/packages/cli/template/vite-react) | **Published scaffold** — npm `^1.7.1`, `lessonkit dev`/`build` scripts; what `npx @lessonkit/cli init` produces |
