...
| [`packages/cli/template/vite-react/`](https://github.com/eddiethedean/lessonkit/tree/main/packages/cli/template/vite-react) | **Published scaffold** — npm `^1.6.6`, `lessonkit dev`/`build` scripts; what `npx @lessonkit/cli init` produces |
