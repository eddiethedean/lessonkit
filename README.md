...
| | |
| --- | --- |
| **Release** | [1.0.2](https://github.com/eddiethedean/lessonkit/blob/main/CHANGELOG.md) — stable public API |
...
Migrating from 0.9.x? See [MIGRATION-0.x-to-1.0.md](https://github.com/eddiethedean/lessonkit/blob/main/docs/MIGRATION-0.x-to-1.0.md).
...
**LessonKit Studio** (preview, separate scope — publish with `studio-v*` tags): [`@lessonkit-studio/schema`](packages/studio-schema) · [`@lessonkit-studio/renderer`](packages/studio-renderer) · [project format v1](docs/guides/studio/project-format-v1.md)
